...
function whoIsBigger(num1, num2) {
	if (num1 > num2) {
		return ('num1 è il maggiore');
	} else {
		return ('num2 è il maggiore');
	}
};
...
const fraseSplittata = splitMe("ciao sono Marco");
...
const deleteOne = function (stringa2, booleano) {
  if (booleano = true) {
	...
	console.log(deleteOne("contemporaneamente", "true"));
...
const onlyLetters = function (stringa3) {
  return stringaNienteNumeri = stringa3.replace(/[0-9]?/g,"");
}
console.log(onlyLetters ("Ho 5 dita sulla mie 2 mani"));
...
console.log(isThisAnEmail("m.tumminia20@gmail.com"));
...
var miaData = new Date(2023,03,01);
...
const deleteProp = function (mioArray, stringa4) {
...
const changeColorUrls = function () {
...
const addToMyList = function (content) {
